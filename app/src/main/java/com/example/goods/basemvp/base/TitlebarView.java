...
public class TitlebarView extends RelativeLayout {
    ...
    private ImageView iv_left, iv_right, tv_right_img;
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.TitlebarView_rightDrawable:
                    ...
                    break;
                case R.styleable.TitlebarView_rightDrawable2:
                    tv_right_img.setImageResource(array.getResourceId(attr, 0));
                    break;
    ...
    private void initView() {
        ...
        tv_right_img = findViewById(R.id.tv_right_img);
    }
    ...
    public void setRightDrawable_img(int res) {
        if (tv_right_img != null) {
            tv_right_img.setImageResource(res);
        }
    }
