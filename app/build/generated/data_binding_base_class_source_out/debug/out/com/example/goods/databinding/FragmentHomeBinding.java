...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull NestedScrollView rootView,
      @NonNull RecyclerView fragmentHomeRv) {
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RecyclerView fragmentHomeRv = rootView.findViewById(id);
      if (fragmentHomeRv == null) {
        break missingId;
      }

      return new FragmentHomeBinding((NestedScrollView) rootView, fragmentHomeRv);
    }
